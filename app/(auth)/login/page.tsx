      ...
      <main className="w-full md:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-sm">
          ...
          <button
            ...
            className="mt-3 w-full bg-surface border border-border rounded-xl py-3.5 px-4 flex items-center justify-center gap-3 hover:border-border-hover hover:bg-surface-hover transition-all duration-200 cursor-pointer focus:outline-none"
          >
            <svg className="w-5 h-5 flex-shrink-0 fill-current text-text" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <span className="text-sm font-semibold text-text">Continue with GitHub</span>
          </button>
          ...
          <p className="mt-8 text-xs text-text-dim text-center leading-relaxed">
            ...
            {' '}This site is completely free. No credit card ever required.
          </p>
        </div>
      </main>
    </div>
