  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 w-full">
      ...
      <div className="bg-surface border border-border rounded-xl p-4 flex items-center justify-between">
        <div>
          <div className="text-xs text-text-muted font-medium">Total Progress</div>
      ...
      <div className="bg-surface border border-border rounded-xl p-4 flex items-center justify-between">
        <div>
          <div className="text-xs text-text-muted font-medium">Easy Questions</div>
          <div className="text-2xl font-mono font-bold text-green mt-1">
      ...
      <div className="bg-surface border border-border rounded-xl p-4 flex items-center justify-between">
        <div>
          <div className="text-xs text-text-muted font-medium">Medium Questions</div>
      ...
      <div className="bg-surface border border-border rounded-xl p-4 flex items-center justify-between">
        <div>
          <div className="text-xs text-text-muted font-medium">Hard Questions</div>
          <div className="text-2xl font-mono font-bold text-red mt-1">
